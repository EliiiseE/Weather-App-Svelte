<script>
    export let city;
    export let today;
    export let src = '/images/sun/8.png';
    export let temperature;
</script>

<a href="../pages/City.svelte" class="hover:no-underline transform hover:scale-110 motion-reduce:transform-none transition duration-300 ease-in-out ">
    <div class='flex flex-col justify-between border-2 border-grey-100 rounded-xl h-65 w-96 p-3 m-6 py-6'>
